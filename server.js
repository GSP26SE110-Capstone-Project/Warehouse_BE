...
import rentalRequestZoneRoutes from './src/routes/RentalRequestZoneRoutes.js';
import warehouseRoutes from './src/routes/WarehouseRoutes.js';
import branchRoutes from './src/routes/BranchRoutes.js';
import zoneRoutes from './src/routes/ZoneRoutes.js';
import rackRoutes from './src/routes/RackRoutes.js';
...
import shipmentRequestRoutes from './src/routes/ShipmentRequestRoutes.js';
import transportContractRoutes from './src/routes/TransportContractRoutes.js';
...
app.use('/api/rental-request-zones', rentalRequestZoneRoutes);
...
app.use('/api/transport-contracts', transportContractRoutes);
